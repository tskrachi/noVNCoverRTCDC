...
import DataCh from "./datachannel.js"
...
export default class RFB extends EventTargetMixin {
    constructor(target, url, options) {
        ...
        this._rtcOptions = options.rtcOptions || [];
        ...
        this._sock.on('close', (e) => {
            Log.Debug("DataChannel on-close event");
            let msg = "";
            if (e.code) {
                msg = "(code: " + e.code;
                if (e.reason) {
        ...
        this._sock.on('error', e => Log.Warn("DataChannel on-error event"));
    ...
    _connect() {
        ...
        try {
            // DataChannel.onopen transitions to the RFB init states
            this._sock.open(this._url, this._rtcOptions);
        } catch (e) {
        ...
        // Make our elRents part of the page
